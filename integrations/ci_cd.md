...
---
  ...
  Then, you can use all the [CLI commands](/client_reference) in your workflows. See the [GitHub Action reference](/github-action-reference/setup_cli_action) for its inputs, outputs, and version-pinning options.
