...
policy. In the [Kosli app](https://app.kosli.com), select **Policies**, choose a policy, and open
its **Decisions** tab. Each row shows the timestamp, the trail and artifact the decision applies
