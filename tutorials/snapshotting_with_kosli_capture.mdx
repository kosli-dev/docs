...
Behavior worth being explicit about, none of it blocking:
...
- **Private-only EKS endpoints require in-VPC deployment.** See the [EKS caveats](#eks-caveats-the-honest-part).
