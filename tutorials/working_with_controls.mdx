...
- **Coverage** — the ratio of deployments where a decision was recorded vs. those where it was not. This is the key metric: controls without decisions are the blind spots that auditors will ask about.

<Frame>
  <img src="/images/tutorials/controls-compliance-coverage.png" alt="Control coverage view showing decision recorded vs. no decision recorded deployments and 78% coverage rate" />
</Frame>
