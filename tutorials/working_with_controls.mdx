...
If a passing decision has been recorded for the control on the trail, the command exits 0. If not, the command exits non-zero and prints the reason, failing the pipeline step.
