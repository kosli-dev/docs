...
<Note>
The `--attestation-data` JSON payload sent by `kosli attest custom` is limited to 1 MB. Distill larger reports into a summary and attach the full document with `--attachments`, as described below.
</Note>
