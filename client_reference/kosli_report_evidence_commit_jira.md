...
description: "Report Jira evidence for a commit in Kosli flows."
---
<Warning>
...
|        --commit string  |  Git commit for which to verify a given evidence. (defaulted in some CIs: /ci-defaults ).  |
...
<AccordionGroup>
	<Accordion title="report Jira evidence for a commit related to one Kosli flow (with Jira Cloud)">
	...
	<Accordion title="report Jira evidence for a commit related to one Kosli flow (with self-hosted Jira)">
	...
	<Accordion title="report Jira  evidence for a commit related to multiple Kosli flows with user-data (with Jira Cloud)">
