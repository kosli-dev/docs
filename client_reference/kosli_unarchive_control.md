---
title: "kosli unarchive control"
tag: "BETA"
description: "Unarchive a Kosli control."
---
...
```shell
kosli unarchive control CONTROL-IDENTIFIER [flags]
```
...
<AccordionGroup>
<Accordion title="unarchive a Kosli control">
```shell
