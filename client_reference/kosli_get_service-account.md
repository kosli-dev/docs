---
title: "kosli get service-account"
description: "Get a service account's metadata."
---

## Synopsis

```shell
kosli get service-account SERVICE-ACCOUNT-NAME [flags]
```
...
<AccordionGroup>
<Accordion title="get the metadata of a service account">
```shell
