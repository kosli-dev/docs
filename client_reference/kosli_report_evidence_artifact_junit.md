...
description: "Report JUnit test evidence for an artifact in a Kosli flow."
---
<Warning>
...
<AccordionGroup>
	<Accordion title="report JUnit test evidence about a file artifact">
	...
	<Accordion title="report JUnit test evidence about an artifact using an available Sha256 digest">
