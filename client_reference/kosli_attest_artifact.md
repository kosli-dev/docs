...
|    -g, --commit string  |  [defaulted] The git commit from which the artifact was created. (defaulted in some CIs: /ci-defaults, otherwise defaults to HEAD ). (default "HEAD")  |
