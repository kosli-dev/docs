...
<AccordionGroup>
<Accordion title="Use Azure Container Registry to get the digests for artifacts in a snapshot">
```shell
...
<Accordion title="Use Docker logs of Azure apps to get the digests for artifacts in a snapshot">
```shell
kosli snapshot azure yourEnvironmentName 
	--azure-client-id yourAzureClientID 
	--azure-client-secret yourAzureClientSecret 
...
<Accordion title="Report digest of an Azure Function app">
```shell
kosli snapshot azure yourEnvironmentName 
	--azure-client-id yourAzureClientID 
	--azure-client-secret yourAzureClientSecret 
