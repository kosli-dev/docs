---
title: "kosli update default-org"
description: "Set the default organization for the current user."
---

## Synopsis

```shell
kosli update default-org ORG-NAME [flags]
```
...
<AccordionGroup>
<Accordion title="set the default organization for the current user">
```shell
