...
description: "Report Gitlab merge request evidence for a commit in Kosli flows."
---
<Warning>
...
|        --gitlab-org string  |  Gitlab organization. (defaulted if you are running in Gitlab Pipelines: /ci-defaults ).  |
...
<AccordionGroup>
	<Accordion title="report a merge request evidence to Kosli">
