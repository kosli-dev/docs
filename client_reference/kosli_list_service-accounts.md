---
title: "kosli list service-accounts"
description: "List service accounts in an organization."
---

## Synopsis

```shell
kosli list service-accounts [flags]
```
...
<AccordionGroup>
<Accordion title="list the service accounts in an organization">
```shell
