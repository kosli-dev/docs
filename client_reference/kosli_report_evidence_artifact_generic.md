...
description: "Report generic evidence to an artifact in a Kosli flow."
---
<Warning>
...
|    -C, --compliant  |  [defaulted] Whether the evidence is compliant or not. A boolean flag /faq/#boolean-flags (default true)  |
...
<AccordionGroup>
	<Accordion title="report a generic evidence about a pre-built docker image">
	...
	<Accordion title="report a generic evidence about a directory type artifact">
	...
	<Accordion title="report a generic evidence about an artifact with a provided fingerprint (sha256)">
	...
	<Accordion title="report a generic evidence about an artifact with evidence file upload">
	...
	<Accordion title="report a generic evidence about an artifact with evidence file upload via API">
