---
title: "kosli get default-org"
description: "Get the default organization for the current user."
---

## Synopsis

```shell
kosli get default-org [flags]
```
...
<AccordionGroup>
<Accordion title="get the default organization for the current user">
```shell
