...
description: "Report a Gitlab merge request evidence for an artifact in a Kosli flow."
---
<Warning>
...
<AccordionGroup>
	<Accordion title="report a merge request evidence to kosli for a docker image">
	...
	<Accordion title="report a merge request evidence (from an on-prem Gitlab) to kosli for a docker image">
