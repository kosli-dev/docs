...
In this case, we recommend using Kosli's Sonar webhook integration ( /integrations/sonar/ ) rather than the CLI to attest the scan results.
...
In [this YAML file](https://app.kosli.com/api/v2/livedocs/cyber-dojo/yaml?ci=github&command=kosli+attest+sonar), which created [this Kosli Event](https://app.kosli.com/api/v2/livedocs/cyber-dojo/event?ci=github&command=kosli+attest+sonar).
	</Tab>
</Tabs>
