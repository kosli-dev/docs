...
beta: false
deprecated: false
description: "Get a deployment from a specified flow."
---
...
<AccordionGroup>
<Accordion title="get previous deployment in a flow">
```shell
kosli get deployment flowName~1 

```
</Accordion>
<Accordion title="get the 10th deployment in a flow">
```shell
kosli get deployment flowName#10 

```
</Accordion>
<Accordion title="get the latest deployment in a flow">
```shell
