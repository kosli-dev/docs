...
<Steps>
  ...
  <Step title="Attest JUnit test results">
    ...
    Kosli automatically parses the JUnit XML to determine pass/fail status. See [`kosli attest system junit`](/client_reference/kosli_attest_junit).
  </Step>
...
<Accordion title="Optional: attest vulnerability scans">
  Your workflow already runs Trivy security scans. You can extend this lab by attesting the scan results as a `system:generic` attestation:
