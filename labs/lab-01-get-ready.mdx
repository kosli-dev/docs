...
description: "Fork the sample repository, verify the CI/CD pipeline, and install the Kosli CLI."
icon: rocket
---
...
<Steps>
  ...
  <Step title="Create a Kosli API key">
    ...
    See [Authenticating to Kosli](/getting_started/authenticating_to_kosli) for more on API key management.
  </Step>
