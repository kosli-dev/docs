...
Data sources provide read-only access to environment metadata. To modify environment configurations, use the [`kosli_environment` resource](/administration/terraform/resources/environment).
