...
<ParamField path="reporterConfig.autoEnvironment" type="bool" default="false">
...
<ParamField path="reporterConfig.environmentDescription" type="string" default="">
