...
<ParamField path="serviceAccount.permissionScope" type="string" default="cluster">
  Specifies whether to create a cluster-wide permissions for the service account or namespace-scoped permissions. allowed values are: `cluster` or `namespace`.
</ParamField>
